...
| 角色 | 名称 | 职责 | 状态 |
|------|------|------|------|
| **PT** | 普罗米修斯 | 架构设计 + 文档 + **编码开发** | ✅ Builder 在岗 |
| **HT** | 赫尔墨斯 | 任务管理 + 进度跟踪 | 待配置 |

> **PT 兼任 Builder**：使用 MiniMax-M2.5 模型进行 TDD 开发

#### 6.5.4.2 预算估算 (基于 MiniMax 模型)

**前提假设**：
- 使用 MiniMax-M2.5 (约 $0.1/M input, $0.3/M output)
...
|------|----------|------------|------------|
| Flutter 框架搭建 | 50 | 750K | $0.075 |
| mDNS 发现服务 | 30 | 450K | $0.045 |
| WebSocket 通信 | 30 | 450K | $0.045 |
| 认证模块 | 20 | 300K | $0.030 |
| UI 界面 | 40 | 600K | $0.060 |
| 测试代码 | 30 | 450K | $0.045 |
| **MVP 小计** | **200** | **3M** | **$0.30** |
...
|------|----------|------------|------------|
| Skills 控制 | 200 | 3M | $0.30 |
| LLM 管理 | 150 | 2.25M | $0.225 |
| 存储管理 | 100 | 1.5M | $0.15 |
| 网络配置 | 100 | 1.5M | $0.15 |
| 测试 | 150 | 2.25M | $0.225 |
| **Phase 2 小计** | **700** | **10.5M** | **$1.05** |
...
| 模块 | 预估交互 | Token 估算 | 成本 (USD) |
|------|----------|------------|------------|
| Ubuntu 裁剪 | 100 | 1.5M | $0.15 |
| OpenClaw 集成 | 200 | 3M | $0.30 |
| Web UI | 150 | 2.25M | $0.225 |
| 驱动适配 | 100 | 1.5M | $0.15 |
| 安装脚本 | 50 | 750K | $0.075 |
| **Phase 3 小计** | **600** | **9M** | **$0.90** |
...
|------|------|------------|-------------|
| MVP | 1天 | 3M | **$0.30** |
| Phase 2 | 1个月 | 10.5M | $1.05 |
| Phase 3 | 1个月 | 9M | $0.90 |
| Phase 4 | 1个月 | 8.2M | $0.82 |
| **总计** | **3个月** | **30.7M** | **$3.07** |

---

> **实际成本极低！** 使用 MiniMax 模型，整个项目Token成本约 **$3**
